 ...
 */
export const EXPLORE_FLAGS: ReadonlyArray<{ flag: string; takesValue: boolean; mcp: string | null; gateway: boolean; form?: string; note?: string }> = [
  // `form` names the Terminal page's composer field (dashboard/src/lib/command.ts) that serializes to the flag.
  // Flags without one are reachable on the Terminal page through its raw command box.
  ...
  { flag: '--no-pom', takesValue: false, mcp: 'pom', gateway: true, form: 'pom' },
  { flag: '--inline', takesValue: false, mcp: 'pom', gateway: true, form: 'pom' },
  ...
  { flag: '--planner-model', takesValue: true, mcp: 'plannerModel', gateway: true, form: 'plannerModel' },
  { flag: '--explorer-model', takesValue: true, mcp: 'explorerModel', gateway: true, form: 'explorerModel' },
  { flag: '--critic-model', takesValue: true, mcp: 'criticModel', gateway: true, form: 'criticModel' },
